...
# 활동
## 강의
### 전국기능경기대회 게임개발직종 대비 강의
- 한국게임과학고등학교 (2022.07), 서귀포산업과학고등학교 (2023.01)
- C#, Unity, 기획서 분석, 개발 전략 등 대회 관련 내용 강의

## 사이드 프로젝트
### [카카오톡 대화 분석기](https://github.com/DYGames/Kakaotalkanalyze)

`C++`
- 카카오톡 대화 내용을 TXT로 추출해 대화 내용 분석
- 대화 나눈 시간대, 많이 말한 사람 등의 정보 제공

### [유튜브 음악 가사창](https://github.com/DYGames/YoutubeLyric)

`C#` `WinForm`
- 알송 가사 서버에서 가사를 가져와 WinForm으로 출력
- 크롬 프로세스의 타이틀로 제목과 가수를 구별
- 최상단 뷰, 투명도 등 편의기능 제공
