...
<div>
    ...
    <div class="period-project">
        <md-block class="markdown-body">
            ...
            #### BindingAdapter의 캡슐화 불가능 문제
            - AAC ViewModel을 이용한 MVVM의 구조를 따르면서, UI State를 도입하여 UI에 표시되는 데이터와 그 업데이트 상태를 캡슐화하고 단방향 데이터 흐름을 구현
            #### Github Actions를 이용해 PR 생성, Push 시 Test, Lint를 검증
